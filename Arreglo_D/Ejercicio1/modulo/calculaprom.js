...
export function calcularPromedio(notas) {
    ...
    // evaluamos el promedio y retornamos un mensaje según el rango
    if (promedio >= 4.5) {
        return "El estudiante tiene promedio alto con " + promedio;
    }
    if (promedio < 4.5 && promedio >= 3.0) {
        return "El estudiante tiene promedio medio con " + promedio;
    } else {
        return "El estudiante tiene promedio bajo con " + promedio;
    }
}